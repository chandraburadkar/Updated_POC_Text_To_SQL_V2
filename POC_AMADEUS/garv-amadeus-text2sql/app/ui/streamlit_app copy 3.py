...
/* NOTE:
   We do NOT use st.chat_message("assistant") anymore
   because Streamlit injects an unavoidable "bubble container"
   that creates the blank rounded blocks you highlighted.
*/
</style>
""",
...
""",
        ...
        # Actions (Save removed, only Export)
        st.markdown('<div class="card">', unsafe_allow_html=True)
