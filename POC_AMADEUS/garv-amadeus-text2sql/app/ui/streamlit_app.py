...
/* Make markdown lists compact inside cards */
.card ul{ margin: 0.35rem 0 0.1rem 0; padding-left: 1.2rem; }
...
.badge-high{ background:#ecfdf5; border-color:#bbf7d0; color:#166534; }
...
.sugg-wrap div[data-testid="stButton"] > button{
...
.sugg-wrap .stButton{ margin-bottom: 6px; }

/* tighten extra gaps between elements */
...
========================= */
@media print {
  /* Hide sidebar + input + controls that waste space */
  section[data-testid="stSidebar"] { display: none !important; }
  div[data-testid="stChatInput"] { display: none !important; }
  header[data-testid="stHeader"] { display: none !important; }

  /* Hide “Edit view”, trace expanders, download buttons if you want a clean report */
  div[data-testid="stExpander"] { break-inside: avoid; }
  .sugg-wrap { display: none !important; }  /* suggested question chips */
  .element-container { margin-bottom: 0.25rem !important; }

  /* Make cards stick together and avoid page break gaps */
  .card { break-inside: avoid; page-break-inside: avoid; }
  .hr { display: none !important; }  /* remove separators in PDF to reduce extra lines */
  
  /* Remove extra top/bottom padding that creates blank bands */
  .block-container {
  ...
  /* Remove background (sometimes prints as grey blocks) */
  .stApp { background: #ffffff !important; }
}

/* Reduce excessive spacing between Streamlit elements */
div[data-testid="stVerticalBlock"] { gap: 0.35rem !important; }
div[data-testid="stMarkdownContainer"] { margin-bottom: 0.35rem !important; }
div[data-testid="stCaptionContainer"] { margin-top: 0.1rem !important; margin-bottom: 0.35rem !important; }
...
def render_suggestions_inline(chat: Dict[str, Any]) -> None:
    ...
    st.markdown("<div class='sugg-label'>Suggested next questions</div>", unsafe_allow_html=True)
